...
class ConceptIdentification():
    ...
    def identify(self, concept_info, 
        ...
        threshold_maps  = self.dissector.get_threshold_maps(dataset_path, save_path, percentile = 85, loader)

        concepts = self.dissector.apply_threshold(test_image, thresholded_maps,
